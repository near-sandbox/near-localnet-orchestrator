...
exports.IntentsProtocolLayer = void 0;
const path = __importStar(require("path"));
const BaseLayer_1 = require("./BaseLayer");
class IntentsProtocolLayer extends BaseLayer_1.BaseLayer {
    /**
     ...
     */
    async generateIntentsConfig(repoPath, chainSignaturesOutputs) {
        const configPath = path.join(repoPath, 'intents-config.json');
     ...
     */
    prepareEnvironment(chainSignaturesOutputs) {
        return {
    ...
    getSupportedChains() {
        ...
        if (config.enable_ethereum !== false)
            chains.push('ethereum');
        if (config.enable_bitcoin !== false)
            chains.push('bitcoin');
        if (config.enable_dogecoin === true)
...
exports.IntentsProtocolLayer = IntentsProtocolLayer;
//# sourceMappingURL=IntentsProtocolLayer.js.map